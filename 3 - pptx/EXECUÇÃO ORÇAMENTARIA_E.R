...
###############################################
source(encoding = 'UTF-8', file = './4- INSUMO/EXECUÇÃO_ORÇAMENTÁRIA_EX_T.R')
source(encoding = 'UTF-8', file = './4- INSUMO/EXECUÇÃO_ORÇAMENTARIA_EX_G.R')
my <- my %>%
  ...
  ph_with(value = glue("Somente o Executivo"),
